-- ChiliPeppr - WS2812/WS2813 LED library - from http://chilipeppr.com/esp32
-- luacheck: globals ZLed tmr ws2812
...
function ZLed.chase(r, g, b)
  ...
  ZLed.t:alarm(300, tmr.ALARM_AUTO, function()
    i = i + 1
    ZLed.buffer:fade(5)
    ZLed.buffer:set(i % ZLed.buffer:size() + 1, g, r, b)
    ws2812.write(ZLed.buffer)
  end)
end
...
function ZLed.indicateDataRecvd()
  ...
  -- ZLed.buffer:set(1, 0, 0, 0)
  ZLed.buffer:set(1, 3, 7, 0) -- base color of light orange
  ws2812.write(ZLed.buffer)
